...
import com.sayyam.weatherly.databinding.FragmentCurrentConditionsBinding
import com.sayyam.weatherly.viewmodels.CurrentConditionViewModel
...
class CurrentConditionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        args.weatherResponse?.let {
            ...
            binding.tvFeelsLike.text="Feels like "+ it.main.feels_like?.minus(273)
                ?.let { it1 -> formatUptoTwoDecimal(it1) } +"\u2103"
